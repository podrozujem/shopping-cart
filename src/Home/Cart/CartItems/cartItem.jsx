      ...
      <div className='cart-item'>
        ...
        <div className='cart-item__actions'>
          ...
          <div className='cart-item__toggle-quantity'>
            <button className='btn button--minus' onClick={handleLess}>
              {' '}
              -{' '}
            </button>
            <span className='cart-item__quantity'> {quantity} </span>
            <button className='btn button--plus' onClick={handleMore}>
              {' '}
              +{' '}
            </button>
          </div>
          <button className='btn button--remove' onClick={() => handleRemoveFromCart(product)}>
            Remove
          </button>
        </div>
      </div>
